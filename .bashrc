...
[[ $- == *i* ]] && source "$(blesh-share)"/ble.sh --noattach && source <(carapace _carapace)
...
alias privateggvnofileinfo='git graphverbose-default-no-file-info --color=always'
...
alias ggnf='privateggvnofileinfo --all'
alias ggm='privateggvnofileinfo --all'

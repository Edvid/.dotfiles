...
vim.keymap.set('n', '<A-2>', [[2<C-PageDown>]])
vim.keymap.set('n', '<A-3>', [[3<C-PageDown>]])
vim.keymap.set('n', '<A-q>', [[4<C-PageDown>]])
vim.keymap.set('n', '<A-w>', [[5<C-PageDown>]])
vim.keymap.set('n', '<A-e>', [[6<C-PageDown>]])
